...
let favoriteFood = ['pizza', 'ice cream', 'mozzarella sticks'];
...
console.log('Added another food to the end, ', favoriteFood);
...
console.log('Favorite foods are now', favoriteFood);
...
favoriteFood.unshift('chocolate');
console.log(`Added a new favorite food to the beginning: ${favoriteFood}`);
...
let comboArray = favoriteFood.concat(animalArray);
